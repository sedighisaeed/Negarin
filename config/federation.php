...
return [
    ...
    */
    ...
    'network_timeline' => env('NEGARIN_NETWORK_TIMELINE', true),
    'network_timeline_days_falloff' => env('NEGARIN_NETWORK_TIMELINE_DAYS_FALLOFF', 90),
    ...
    'migration' => env('NEGARIN_ACCT_MIGRATION_ENABLED', true),
];

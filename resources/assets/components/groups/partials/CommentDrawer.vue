				...
				<div
					...
					<div class="media-body">
						...
						<!-- <div v-if="replyChildId == status.id && status.reply_count" class="media media-status align-items-top mt-3">
							...
							<a href="https://negarin.test/groups/328821658771132416/user/321493203255693312"><img src="https://negarin.test/storage/avatars/321493203255693312/5a6nqo.jpg?v=2" width="32" height="32" class="rounded-circle media-avatar border"></a>
							<div class="media-body"><div class="media-body-comment"><p class="media-body-comment-username"><a href="https://negarin.test/groups/328821658771132416/user/321493203255693312">
								dansup
								...
								Like
							</a> <span class="mx-1">·</span> <a href="https://negarin.test/groups/328821658771132416/p/358529382599041029" class="font-weight-bold text-muted">
							1h

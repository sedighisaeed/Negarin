<template>
    <div class="footer-component">
        <div class="footer-component-links">
            ...
            <a href="https://negarin.org/mobile-apps" target="_blank">Mobile Apps</a>
        </div>

        <div class="footer-component-attribution">
            <div><span>© {{ getYear() }} {{ config.domain }}</span></div>
            <div class="spacer">·</div>
            <div><a href="https://negarin.org" class="text-bluegray-500 font-weight-bold">Powered by Negarin</a></div>
            <div class="spacer">·</div>

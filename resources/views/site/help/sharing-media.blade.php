...
@section('section')
	...
	<p>
		<a class="text-dark font-weight-bold" data-toggle="collapse" href="#collapse3" role="button" aria-expanded="false" aria-controls="collapse3">
			<i class="fas fa-chevron-down mr-2"></i>
			How do I add a caption before sharing my photos or videos on negarin?
		</a>
		<div class="collapse" id="collapse3">
			<div>
				During the compose process, you will see the <span class="font-weight-bold">Caption</span> input. Captions are optional and limited to <span class="font-weight-bold">{{config_cache('negarin.max_caption_length')}}</span> characters.
			</div>
		</div>
	</p>
	<p>
	...
	<p>
		...
		<div class="collapse" id="collapse6">
			<div>
				...
				<ul>
					@foreach(explode(',', config_cache('negarin.media_types')) as $type)

...
@section('section')
  ...
  <p> 
    ...
    <div class="collapse" id="collapse2">
      <div>
        negarin is a federated application, changing your username is not supported in every <a href="https://en.wikipedia.org/wiki/Federated_architecture">federated software</a> so we cannot allow username changes. Your best option is to create a new account with your desired username.
      </div>
    </div>
  </p>
  <hr>
  ...
  <p>
    ...
    <div class="collapse" id="migrate-collapse1">
      <div>
        To migrate your account successfully, your old account must be on a negarin or Mastodon server, or one that supports the Mastodon Account Migration <a href="https://docs.joinmastodon.org/spec/activitypub/#Move">extension</a>.
        <hr>
  ...
  <p>
    ...
    <div class="collapse" id="migrate-collapse3">
      <div>
        Post migrations are officially supported on negarin servers running v0.11.9+ and higher, and when enabled by server admins.
        <hr>
        It can take a few hours to process post migration imports, please contact admins if it takes longer than 24 hours.
      </div>
    </div>
  ...
  <p> 
    ...
    <div class="collapse" id="del-collapse1">
      <div>
        ...
        <ol class="">
          <li>Log into <a href="{{config('app.url')}}">{{config('negarin.domain.app')}}</a></li>
  ...
  @if(config('negarin.account_deletion'))
  <p> 
    ...
    <div class="collapse" id="del-collapse2">
      <div>
        @if(config('negarin.account_delete_after') == false)
        ...
        @else
        <div class="bg-light p-3 mb-4">
          <p class="mb-0">When you delete your account, your profile, photos, videos, comments, likes and followers will be <b>permanently removed</b> after {{config('negarin.account_delete_after')}} days. You can log in during that period to prevent your account from permanent deletion. If you'd just like to take a break, you can <a href="{{route('settings.remove.temporary')}}">temporarily disable</a> your account instead.</p>
        </div>
        @endif
        ...
        <ol class="">
          <li>Go to <a href="{{route('settings.remove.permanent')}}">the <span class="font-weight-bold">Delete Your Account</span> page</a>.  If you're not logged into negarin on the web, you'll be asked to log in first. You can't delete your account from within a mobile app.</li>
          <li>Navigate to the <a href="{{route('settings.security')}}">Security Settings</a></li>
          <li>Confirm your account password.</li>

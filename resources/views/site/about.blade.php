...
<body>
	<main id="content">
		...
		<div class="px-4 py-5 my-5 text-center">
			<a href="/">
				<img class="d-block mx-auto mb-4" src="/img/negarin-icon-color.svg" alt="" width="72" height="57">
			</a>
			...
			<div class="col-lg-6 mx-auto py-3">
			  <p class="mb-4 font-weight-light text-left" style="font-size: 26px; line-height: 40px;">
				{!! config_cache('app.description') ?? config_cache('app.short_description') ?? __('site.negarin_is_an_image_sharing_platform_etc') !!}
			  </p>
			</div>
		</div>
		...
		<div class="container my-5">
			<div class="row p-4 pb-0 pt-lg-5 align-items-center rounded-3">
				<div class="col-lg-6 p-3 p-lg-5 pt-lg-3">
					...
					<p class="h4 font-weight-light">{{__('site.share_posts_with_up_to')}} {{config_cache('negarin.max_album_length')}} {{__('site.photos')}}</p>
				</div>
		...
		<div id="stats" class="container">
			<div class="row mb-4">
				<div class="col">
					...
					@if(config_cache('negarin.open_registration'))
					<div class="section-spacer"></div>

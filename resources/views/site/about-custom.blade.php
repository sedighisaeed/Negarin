...
<div class="jumbotron jumbotron-fluid bg-primary text-white mb-0 py-4">
	<div class="container">
		...
		<p class="h3 font-weight-light py-4">{{$page->title ?? 'negarin is an image sharing platform, an ethical alternative to centralized platforms.'}}</p>
	</div>
</div>
<div class="bg-white">
...
@push('meta')
<meta property="og:description" content="negarin is an image sharing platform, an ethical alternative to centralized platforms.">
@endpush

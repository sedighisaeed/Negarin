...
<form method="post" action="{{route('settings.sponsor')}}">
	...
	<div class="form-group row">
		...
		<div class="col-sm-9">
			<input type="text" class="form-control" id="liberapay" name="liberapay" placeholder="liberapay.com/negarin" value="{{$sponsors['liberapay']}}">
			<p class="help-text small text-muted font-weight-bold">
				Example: liberapay.com/negarin
			</p>
		</div>
	</div>
	<div class="form-group row">
		...
		<div class="col-sm-9">
			<input type="text" class="form-control" id="opencollective" name="opencollective" placeholder="opencollective.com/negarin" value="{{$sponsors['opencollective']}}">
			<p class="help-text small text-muted font-weight-bold">
				Example: opencollective.com/negarin
			</p>
		</div>
	</div>
	<hr>

...
@section('section')
  ...
  <div class="title">
    ...
    <p class="lead">Invite friends or family to join you on <span class="font-weight-bold">{{config('negarin.domain.app')}}</span></p>
  </div>
  <hr>

  @if(config('negarin.user_invites.limit.daily') != 0)
  <div class="alert alert-warning">
    <div class="font-weight-bold">Warning</div>
    <p class="mb-0">You may only send {{config('negarin.user_invites.limit.daily')}} invite(s) per day.</p>
  </div>
  @endif

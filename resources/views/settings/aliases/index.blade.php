                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-5">
                        <div class="d-flex h-100 justify-content-center align-items-center flex-column">
                            ...
                            <hr>
                            <p class="mb-0 small">We support migration to and from negarin, Mastodon and most other platforms that use the Mastodon Account Migration <a href="https://docs.joinmastodon.org/spec/activitypub/#Move">extension</a>.</p>
                        </div>

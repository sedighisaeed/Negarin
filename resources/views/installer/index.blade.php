				...
				<div class="row w-100 h-100 d-flex align-items-center justify-content-center">
					<div class="col-12">
						<p class="text-center py-3">
							<a href="/installer">
								<img src="/img/negarin-icon-color.svg" width="60" height="60">
							</a>
						</p>
						...
						<p class="d-flex justify-content-between text-white pt-2 px-2">
							<a class="font-weight-bold text-white" href="https://docs.negarin.org/running-negarin/installation.html" target="_blank">Help</a>
							<span class="font-weight-bold">v{{config('negarin.version')}}</span>
						</p>
					</div>
				</div>
			</div>

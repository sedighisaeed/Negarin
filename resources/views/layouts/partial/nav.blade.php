<nav class="navbar navbar-expand navbar-light navbar-laravel shadow-none border-bottom sticky-top py-1">
	<div class="container">
			<a class="navbar-brand d-flex align-items-center" href="{{ config('app.url') }}" title="Logo">
				<img src="/img/negarin-icon-color.svg" height="30px" class="px-2" loading="eager" alt="negarin logo">
			...
			@guest
				...
				@if(config_cache('negarin.open_registration') && in_array(config_cache('system.user_mode'), ['default', 'admin']))
					<li>

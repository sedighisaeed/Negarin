<h2><span style="opacity:0.5;">Let's begin setting up your account on</span> <strong style="opacity: 1">{{ config('negarin.domain.app') }}</strong></h2>
<form method="post">
    @csrf
    ...
    <div class="my-5 details-form">
        <div class="details-form-field">
            ...
            <div class="input-group">
                ...
                <div class="input-group-append">
                    <span class="input-group-text bg-dark border-dark text-muted font-weight-bold" id="username-addon">&commat;{{ config('negarin.domain.app') }}</span>
                </div>
            </div>
        ...
        <div class="border-top border-dark mt-3 pt-4">
            <p class="lead">
                Our moderators manually review sign-ups. To assist in the processing of your registration, please provide some information about yourself and explain why you wish to create an account on {{ config('negarin.domain.app') }}.
            </p>
        </div>
        <div class="details-form-field">

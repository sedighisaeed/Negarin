	    ...
	    <div class="row justify-content-center">
	        <div class="col-xl-6 col-lg-5 col-md-7 col-12">
	        	<div class="text-center">
	                <a href="/">
	                	<img src="/img/negarin-icon-white.svg" height="60px">
	            	</a>
	                        ...
	                        <div class="form-group row">
	                            <div class="col-md-12">
	                                ...
	                                <input
	                                	...
	                                	minlength="{{config('negarin.min_password_length')}}"
	                                	maxlength="72"
	                                ...
	                                @else
	                                	<p class="help-text small text-muted mb-0 mt-1">Enter a new password between {{config('negarin.min_password_length')}}-72 characters long.</p>
	                                @endif
	                            </div>
	                        </div>

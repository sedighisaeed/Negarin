  ...
  <div class="row">
  	<div class="col-12 col-md-3">
  		<div class="card shadow-none border mb-3 border-left-blue">
  			<div class="card-body text-center">
  				<p class="font-weight-ultralight h2 mb-0 text-truncate" title="{{$sys['negarin']}}" data-toggle="tooltip">{{$sys['negarin']}}</p>
  			</div>
  			<div class="card-footer font-weight-bold py-0 text-center bg-white">negarin</div>
      </div>
  	</div>
    <div class="col-12 col-md-3">
      <div class="card shadow-none border mb-3 border-left-blue">
...
$(document).ready(function() {
  ...
  function latestRelease() {
    let api = 'https://api.github.com/repos/negarin/negarin/releases';

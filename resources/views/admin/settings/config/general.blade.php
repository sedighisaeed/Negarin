<form method="post">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-9">
        <div class="form-check pb-2">
          <input class="form-check-input" type="checkbox" id="open_registration" name="open_registration" {{config('negarin.open_registration') === true ? 'checked=""' : '' }}>
          <label class="form-check-label font-weight-bold" for="open_registration">
            {{config('negarin.open_registration') === true ? 'Open' : 'Closed' }}
          </label>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-9">
        <div class="form-check pb-2">
          <input class="form-check-input" type="checkbox" id="enforce_email_verification" name="enforce_email_verification" {{config('negarin.enforce_email_verification') === true ? 'checked=""' : '' }}>
          <label class="form-check-label font-weight-bold" for="open_registration">
            {{config('negarin.enforce_email_verification') == true ? 'Enabled' : 'Disabled' }}
          </label>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-9">
        <input type="text" class="form-control" placeholder="1000000" name="max_account_size" value="{{config('negarin.max_account_size')}}">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-9">
        <input type="text" class="form-control" placeholder="15000" name="max_photo_size" value="{{config('negarin.max_photo_size')}}">
        <span class="help-text font-weight-bold text-muted small">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-9">
        <input type="text" class="form-control" placeholder="500" name="caption_limit" value="{{config('negarin.max_caption_length')}}">
        <span class="help-text font-weight-bold text-muted small">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-9">
        <input type="text" class="form-control" placeholder="3" name="album_limit" value="{{config('negarin.max_album_length')}}">
        <span class="help-text font-weight-bold text-muted small">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-9">
        <input type="text" class="form-control" placeholder="80" name="image_quality" value="{{config('negarin.image_quality')}}">
        <span class="help-text font-weight-bold text-muted small">

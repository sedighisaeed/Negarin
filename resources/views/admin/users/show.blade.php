		...
		<div class="card shadow-none border">
            ...
            <div class="list-group list-group-flush details-list">
                ...
                <div class="list-group-item details-list-item">
                    ...
                    <p class="details-list-item-value text-truncate">{{PrettyNumber::size($profile->media()->sum('size'))}}<span class="text-muted"> / {{PrettyNumber::size(config_cache('negarin.max_account_size') * 1000)}}</p>
                </div>

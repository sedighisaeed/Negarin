...
class AdminSettingsService
{
    ...
    {
        $cloud_storage = (bool) config_cache('negarin.cloud_storage');
        ...
        return [
            ...
            'instagram_import' => (bool) config_cache('negarin.import.instagram.enabled'),
            'autospam_enabled' => (bool) config_cache('negarin.bouncer.enabled'),
        ];
    }
    ...
    public static function getUsers()
    {
        ...
        return [
            'require_email_verification' => (bool) config_cache('negarin.enforce_email_verification'),
    ...
    {
        return [
            'allow_app_registration' => (bool) config_cache('negarin.allow_app_registration'),
            'app_registration_rate_limit_attempts' => config_cache('negarin.app_registration_rate_limit_attempts'),
            'app_registration_rate_limit_decay' => config_cache('negarin.app_registration_rate_limit_decay'),
            'app_registration_confirm_rate_limit_attempts' => config_cache('negarin.app_registration_confirm_rate_limit_attempts'),
            'app_registration_confirm_rate_limit_decay' => config_cache('negarin.app_registration_confirm_rate_limit_decay'),

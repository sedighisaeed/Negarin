...
class AvatarStorage extends Command
{
    ...
    {
        $this->info('negarin Avatar Storage Manager');
        $this->line(' ');
        $segments = [
            [
                'Local',
        ...
        if((bool) config_cache('negarin.cloud_storage') && config('instance.avatar.local_to_cloud')) {
        ...
        $options = (bool) config_cache('negarin.cloud_storage') && config('instance.avatar.local_to_cloud') ?
            [
                'Cancel',
    ...
    protected function refetchRemoteAvatars()
    {
        ...
        if((bool) config_cache('negarin.cloud_storage') == false && config_cache('federation.avatars.store_local') == false) {

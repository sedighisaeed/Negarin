...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        if ((bool) config_cache('negarin.cloud_storage') && (bool) config_cache('media.delete_local_after_cloud')) {
        ...
        if (config('import.instagram.enabled')) {
            ...
            if (config('import.instagram.storage.cloud.enabled') && (bool) config_cache('negarin.cloud_storage')) {

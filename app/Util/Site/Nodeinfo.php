...
class Nodeinfo
{
    public static function get()
    {
        $res = Cache::remember('api:nodeinfo', 900, function () {
            ...
            return [
                'metadata' => [
                    ...
                    'software' => [
                        'homepage' => 'https://negarin.org',
                        'repo' => 'https://github.com/negarin/negarin',
                    ],
                    'config' => $features,
                ],
                'protocols' => [
        ...
        $res['openRegistrations'] = (bool) config_cache('negarin.open_registration');
    ...
    public static function wellKnown()
    {
        return [
            'links' => [
                [
                    'href' => config('negarin.nodeinfo.url'),

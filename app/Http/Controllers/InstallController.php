...
class InstallController extends Controller
{
    ...
    protected function checkDatabase($request)
    {
		...
		$name = $request->input('db_name', 'negarin');
    ...
    protected function createConfiguration($request)
    {
    	...
    	$this->updateConfig('APP_NAME="negarin Prod"', 'APP_NAME="'.$request->input('name').'"');
    	...
    	$this->updateConfig('DB_DATABASE=negarin', 'DB_DATABASE='.$request->input('db_name'));
    	$this->updateConfig('DB_USERNAME=negarin', 'DB_USERNAME='.$request->input('db_username'));
    	$this->updateConfig('DB_PASSWORD=negarin', 'DB_PASSWORD='.$request->input('db_password'));

...
class ImportPostController extends Controller
{
    ...
    public function getConfig(Request $request)
    {
        return [
            ...
            'allow_image_webp' => config('import.instagram.allow_image_webp') && str_contains(config_cache('negarin.media_types'), 'image/webp'),
    ...
    public function storeMedia(Request $request)
    {
        ...
        if (config('import.instagram.allow_image_webp') && str_contains(config_cache('negarin.media_types'), 'image/webp')) {

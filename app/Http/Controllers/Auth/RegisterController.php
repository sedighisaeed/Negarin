    ...
    */
    ...
    public function validator(array $data)
    {
        ...
        $rules = [
            ...
            'rt' => $rt,
            'name' => 'nullable|string|max:'.config('negarin.max_name_length'),
            'username' => $usernameRules,
            'email' => $emailRules,
            'password' => 'required|string|min:'.config('negarin.min_password_length').'|confirmed',
        ];
    ...
    public function showRegistrationForm()
    {
        if ((bool) config_cache('negarin.open_registration')) {
            ...
            $hasLimit = config('negarin.enforce_max_users');
            if ($hasLimit) {
                $limit = config('negarin.max_users');
    ...
    {
        abort_if(config_cache('negarin.open_registration') == false, 400);

...
class AppRegisterController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($exists) {
            ...
            return redirect()->away("negarin://verifyEmail?{$errorParams}");
        }
        ...
        return redirect()->away("negarin://verifyEmail?{$queryParams}");
    }
    ...
    public function onboarding(Request $request)
    {
        ...
        $this->validate($request, [
            ...
            'password' => 'required|string|min:'.config('negarin.min_password_length'),
        ]);
        ...
        $token = $user->createToken('negarin App', ['read', 'write', 'follow', 'push']);

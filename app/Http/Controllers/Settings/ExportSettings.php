...
trait ExportSettings
{
    ...
    public function exportFollowing()
    {
        ...
        $filename = 'negarin-following.json';
        ...
        try {
            ...
            return response()->stream(
                ...
                [
                    'Content-Type' => 'application/json',
                    'Content-Disposition' => 'attachment; filename="negarin-following.json"',
                ]
            );
    ...
    public function exportFollowers()
    {
        ...
        $userExportPath = 'user_exports/'.$userId;
        $filename = 'negarin-followers.json';
        $tempPath = $userExportPath.'/'.$filename;
        ...
        try {
            ...
            return response()->stream(
                ...
                [
                    'Content-Type' => 'application/json',
                    'Content-Disposition' => 'attachment; filename="negarin-followers.json"',
                ]
            );
    ...
    public function exportStatuses(Request $request)
    {
        ...
        $filename = 'negarin-statuses.json';
        $tempPath = $userExportPath.'/'.$filename;
        ...
        try {
            ...
            return response()->stream(
                ...
                [
                    'Content-Type' => 'application/json',
                    'Content-Disposition' => 'attachment; filename="negarin-statuses.json"',
                ]
            );

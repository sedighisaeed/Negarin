...
trait HomeSettings
{
    public function home()
    {
        ...
        $storage['limit'] = config_cache('negarin.max_account_size') * 1024;
        $storage['used'] = $used;
    ...
    public function homeUpdate(Request $request)
    {
        $this->validate($request, [
            ...
            'bio' => 'nullable|string|max:'.config('negarin.max_bio_length'),
        ...
        $enforceEmailVerification = config_cache('negarin.enforce_email_verification');
    ...
    public function emailUpdate(Request $request)
    {
        ...
        $validate = config_cache('negarin.enforce_email_verification');

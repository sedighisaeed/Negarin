...
trait Instagram
{
	...
	{
		if((bool) config_cache('negarin.import.instagram.enabled') != true) {
    ...
    public function instagramStepOneStore(Request $request, $uuid)
    {
        ...
        $max = 'max:' . config('negarin.import.instagram.limits.size');
        ...
        $limit = config('negarin.import.instagram.limits.posts');

...
trait AdminReportController
{
    ...
    public function reportsApiSpamHandle(Request $request)
    {
        ...
        abort_if(
            ...
            ! config('negarin.account_deletion'),
            404,
    ...
    public function exportModeratedProfiles(Request $request)
    {
        return response()->streamDownload(function () {
            ...
            echo json_encode([
                '_negarin_export' => true,
                'meta' => [
                    'ns' => 'https://negarin.org',
                    'origin' => config('negarin.domain.app'),
                    'date' => now()->format('c'),
    ...
    public function createModeratedProfile(Request $request)
    {
        ...
        abort_if($host === config('negarin.domain.app'), 400, 'You cannot add local users!');

...
trait AdminSettingsController
{
    ...
    {
        $cloud_storage = ConfigCacheService::get('negarin.cloud_storage');
        ...
        $types = explode(',', ConfigCacheService::get('negarin.media_types'));
        ...
        $openReg = (bool) config_cache('negarin.open_registration');
    ...
    public function settingsHomeStore(Request $request)
    {
        ...
        ConfigCacheService::put('negarin.open_registration', (bool) $orb);
        ...
        $media_types = explode(',', config_cache('negarin.media_types'));
        ...
        if ($media_types !== $media_types_original) {
            ConfigCacheService::put('negarin.media_types', implode(',', array_unique($media_types)));
        }
        ...
        $keys = [
            ...
            'max_photo_size' => 'negarin.max_photo_size',
            'max_album_length' => 'negarin.max_album_length',
            'image_quality' => 'negarin.image_quality',
            'account_limit' => 'negarin.max_account_size',
        ...
        $bools = [
            ...
            // 'open_registration' => 'negarin.open_registration',
            'mobile_apis' => 'negarin.oauth_enabled',
            'stories' => 'instance.stories.enabled',
            'ig_import' => 'negarin.import.instagram.enabled',
            'spam_detection' => 'negarin.bouncer.enabled',
            'require_email_verification' => 'negarin.enforce_email_verification',
            'enforce_account_limit' => 'negarin.enforce_account_limit',
            'show_custom_css' => 'uikit.show_custom.css',
            'show_custom_js' => 'uikit.show_custom.js',
            'cloud_storage' => 'negarin.cloud_storage',
    ...
    {
        $sys = [
            'negarin' => config('negarin.version'),
            'php' => phpversion(),
            'laravel' => app()->version(),
        ];
    ...
    public function settingsApiUpdateHomeType($request)
    {
        ...
        ConfigCacheService::put('negarin.open_registration', $regStatus === 'open');
        ...
        if ($cloudStorage !== (bool) config_cache('negarin.cloud_storage')) {
            if (! $cloudStorage) {
                ConfigCacheService::put('negarin.cloud_storage', false);
            } else {
                $cloud_disk = config('filesystems.cloud');
                $cloud_ready = ! empty(config('filesystems.disks.'.$cloud_disk.'.key')) && ! empty(config('filesystems.disks.'.$cloud_disk.'.secret'));
                if (! $cloud_ready) {
                    ...
                    ConfigCacheService::put('negarin.cloud_storage', true);
                }
            }
        }
        ...
        ConfigCacheService::put('negarin.oauth_enabled', $request->boolean('mobile_apis'));
        ConfigCacheService::put('instance.stories.enabled', $request->boolean('stories'));
        ConfigCacheService::put('negarin.import.instagram.enabled', $request->boolean('instagram_import'));
        ConfigCacheService::put('negarin.bouncer.enabled', $request->boolean('autospam_enabled'));
    ...
    public function settingsApiUpdateMediaType($request)
    {
        ...
        ConfigCacheService::put('negarin.media_types', $request->input('media_types'));
        ConfigCacheService::put('negarin.image_quality', $request->input('image_quality'));
        ConfigCacheService::put('negarin.max_album_length', $request->input('max_album_length'));
        ConfigCacheService::put('negarin.max_photo_size', $request->input('max_photo_size'));
        ConfigCacheService::put('negarin.optimize_image', $request->boolean('optimize_image'));
        ConfigCacheService::put('negarin.optimize_video', $request->boolean('optimize_video'));
    ...
    public function settingsApiUpdatePostsType($request)
    {
        ...
        ConfigCacheService::put('negarin.max_caption_length', $request->input('max_caption_length'));
        ConfigCacheService::put('negarin.max_altext_length', $request->input('max_altext_length'));
        $res = [
    ...
    public function settingsApiUpdatePlatformType($request)
    {
        ...
        ConfigCacheService::put('negarin.allow_app_registration', $request->boolean('allow_app_registration'));
        ConfigCacheService::put('negarin.app_registration_rate_limit_attempts', $request->input('app_registration_rate_limit_attempts'));
        ConfigCacheService::put('negarin.app_registration_rate_limit_decay', $request->input('app_registration_rate_limit_decay'));
        ConfigCacheService::put('negarin.app_registration_confirm_rate_limit_attempts', $request->input('app_registration_confirm_rate_limit_attempts'));
        ConfigCacheService::put('negarin.app_registration_confirm_rate_limit_decay', $request->input('app_registration_confirm_rate_limit_decay'));
    ...
    public function settingsApiUpdateUsersType($request)
    {
        ...
        ConfigCacheService::put('negarin.enforce_email_verification', $request->boolean('require_email_verification'));
        ConfigCacheService::put('negarin.enforce_account_limit', $request->boolean('enforce_account_limit'));
        ConfigCacheService::put('negarin.max_account_size', $request->input('max_account_size'));
    ...
    public function settingsApiUpdateStorageType($request)
    {
        ...
        ConfigCacheService::put('negarin.cloud_storage', $request->input('primary_disk') === 'cloud');
        $res = [
